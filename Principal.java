...
public class Principal extends javax.swing.JFrame {
    ...
    private static void mostrarVentanaActual() {
        if (index < candidatos.size()) {
            ...
            // Mostrar ganador
            Candidatos ganador = determinarGanador();
            ...
            JOptionPane.showMessageDialog(null, encontrarPartidoConMasCandidatos(candidatos), "Resultados", JOptionPane.INFORMATION_MESSAGE);
            JOptionPane.showMessageDialog(null, top3CiudadesConMenosCandidatos(candidatos), "Resultados", JOptionPane.INFORMATION_MESSAGE);
            System.exit(0);

        }
    }
    private static Candidatos determinarGanador() {
    ...
    private static String encontrarPartidoConMasCandidatos(List<Candidatos> candidatos) {
    ...
    private static String top3CiudadesConMenosCandidatos(List<Candidatos> candidatos) {
    ...
    private static List<String> obtenerListaDeObjetos() {
        // Implementa tu lógica para obtener la lista de objetos aquí
        // Por ejemplo, podrías devolver una lista de cadenas estáticas para este ejemplo
        return List.of("Objeto1", "Objeto2", "Objeto3");
    }
    ...
    private void initComponents() {
       ...
       Color fondo = new Color(28,30,65);
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/votacion.png"))); // NOI18N
        Menu.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, -1, -1));
 ...
 */
    ...
    public static void borrarPorCedula(String candidatoparaeliminar){
        for (Candidatos candidato : candidatos){
